...
It has an integrated dependency injection system, inspired by Angular too. It requires pre-registering the "injectables" (like all the other dependency injection systems I know), so, it adds to the verbosity and code repetition.
